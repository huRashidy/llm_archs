...
if __name__ == "__main__":
    ...
    matrix = [
        ("1. Baseline (MHA + Sequential Res) compiled", {**base_model_args, "num_kv_heads": 6, "parallel_residual": False}),
        ("2. Variant A (Parallel Residual) compiled", {**base_model_args, "num_kv_heads": 6, "parallel_residual": True}),
        ("3. Variant B (GQA: 2 KV Heads) compiled", {**base_model_args, "num_kv_heads": 2, "parallel_residual": False}),
        ("4. Variant C (GQA + Parallel Res) compiled", {**base_model_args, "num_kv_heads": 2, "parallel_residual": True}),
    ]
    ...
    # Master summary file
    with open("results/benchmark_summary_compiled.json", "w") as f:
